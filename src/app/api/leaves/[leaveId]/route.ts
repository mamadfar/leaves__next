...
export async function DELETE(request: NextRequest, { params }: { params: { leaveId: string } }) {
  try {
    ...
    if (leave.employeeId !== employeeId) {
      return NextResponse.json({ error: "Not authorized to delete this leave" }, { status: 403 });
    }
